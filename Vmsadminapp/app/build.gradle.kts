...
android {
    ...
    defaultConfig {
        applicationId = "com.plixo.control"
        minSdk = 24
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
    ...
    buildTypes {
        release {
            ...
            // Only apply release signing if credentials are present in local.properties
            val hasKeystore = localProps.getProperty("KEYSTORE_PATH") != null
            if (hasKeystore) {
